        ...
        <div className="about__grid">
          ...
          <div className="about__left">
            <div className="about__bio glass-card">
              ...
              <div className="about__links" style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              ...
              {achievements.map((item, i) => (
                <div key={i} className="about__achievement-item">
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    ...
                    <button onClick={() => handleDownloadCertificate(item)} className="about__achievement-view" style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: 'inherit', padding: 0 }} title="Download as PDF">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    </button>
                  </div>
                </div>
